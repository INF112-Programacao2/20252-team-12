...
class EstudantePosGraduacao : public Estudante {
    ...
    public:
        EstudantePosGraduacao(const std::string& _nome, const std::string& _data_de_nascimento, const std::string& _email, const std::string& _senha, const std::string &_matricula, const std::string &_curso,const int &_valorRU, const std::string &_tipoPos, const std::string &_linhaDePesquisa);
